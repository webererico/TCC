...
def informa_estado(controle_lab , controle_sala1, controle_sala2):
	mylcd.lcd_display_string("LAB: ",2, 1)
	mylcd.lcd_display_string("S1: ",2, 6)
	mylcd.lcd_display_string("S2: ",2, 9)
	if(controle_lab == "manual"):
		mylcd.lcd_display_string("M",2, 1)
	else:
		mylcd.lcd_display_string("A",2, 1)
	if(controle_sala1 == "manual"):
		mylcd.lcd_display_string("M",2, 7)
	else:
		mylcd.lcd_display_string("A",2, 7)
	if(controle_sala2 == "manual"):
		mylcd.lcd_display_string("M",2, 10)
	else:
		mylcd.lcd_display_string("A",2, 10)
